...
margin-bottom: auto;">
        ...
        <div class="card-body">
            @if (isset($menu))
                {!! Form::model($menu,['route'=> ['restrito.menus.update',$menu->id],'class'=>'form','method'=>'put', 'enctype' => 'multipart/form-data', 'id' => 'fileForm']) !!}
            @else
                {!! Form::open(['route'=>'restrito.menus.store','class'=>'form', 'enctype' => 'multipart/form-data', 'id' => 'fileForm']) !!}
            @endif
